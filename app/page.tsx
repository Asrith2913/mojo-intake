      ...
      <div className="mx-auto max-w-6xl">
        <div className="rounded-3xl border bg-white p-10 shadow-sm">
          ...
          <p className="mt-4 max-w-4xl text-lg text-gray-600">
            Capture legal inquiries, ask focused follow-up questions, extract structured intake
            data, score urgency, route leads, and draft follow-up communication.
          </p>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link
              href="/review"
              className="rounded-2xl border border-gray-300 px-5 py-3 text-gray-700 transition hover:bg-gray-100"
            >
