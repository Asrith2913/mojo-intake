    ...
    <main className="min-h-screen bg-gray-50 px-6 py-12">
      <div className="mx-auto max-w-5xl">
        <div className="rounded-3xl border bg-white p-8 shadow-sm">
          <h1 className="text-3xl font-bold text-gray-900">Start Legal Intake</h1>
          ...
          <form onSubmit={generateQuestions} className="mt-8 space-y-4">
            <label className="block">
              ...
              <textarea
                ...
                className="min-h-[220px] w-full rounded-2xl border border-gray-300 p-4 text-gray-900 outline-none placeholder:text-gray-400 focus:ring"
            ...
            <button
              ...
              className="rounded-2xl bg-black px-5 py-3 text-white transition hover:opacity-90 disabled:bg-gray-400 disabled:text-white disabled:cursor-not-allowed"
            >
          ...
          {questions.length > 0 && (
            <div className="mt-10 space-y-5">
              <h2 className="text-xl font-semibold text-gray-900">Follow-up Questions</h2>
              ...
              {questions.map((question, index) => (
                <div key={`${question}-${index}`} className="rounded-2xl border p-4">
                  ...
                  <textarea
                    ...
                    className="mt-3 min-h-[100px] w-full rounded-xl border border-gray-300 p-3 text-gray-900 outline-none placeholder:text-gray-400 focus:ring"
              ...
              <button
                ...
                className="rounded-2xl bg-blue-600 px-5 py-3 text-white transition hover:opacity-90 disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
